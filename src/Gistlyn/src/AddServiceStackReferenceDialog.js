                    ...
                    if (validUrl) {
                        ...
                        fetch(proxyUrl)
                            ...
                            r.text().then(function (content) {
                                ...
                                _this.setState({ valid: valid, baseUrl: baseUrl, content: content, loading: false });

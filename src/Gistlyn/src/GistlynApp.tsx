...
export class GistlynApp extends React.Component<any, any> {
            ...
            <div id="body" onClick={e => this.handleBodyClick(e) } className={UA.getClassList()}>
                <div className="titlebar">
                    <div className="container">
                        ...
                        <h3 title="Home" onClick={goHome} style={{ cursor:"pointer" }}>Gistlyn</h3> <sup style={{ padding: "7px 0 0 5px", fontSize: "12px", fontStyle: "italic" }}>BETA</sup>
                        <div id="gist">
                            { meta
